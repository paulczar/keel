...
```bash
ls ~/.keel/keel/content/skills/ 2>/dev/null
```
...
- **Personal** (learnings, gotchas, preferences) → move to `~/.keel/local/knowledge/`
...
- **Rules**: `~/.keel/keel/content/rules/`
- **Skills**: `~/.keel/keel/content/skills/`
- **Knowledge**: `~/.keel/keel/content/knowledge/` (keel framework)
